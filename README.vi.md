...
Floor plan sinh từ số đo thật, tỉ lệ 1px = 1cm, kèm kiểm tra ergonomics tự động:

<p align="center">
  <img src="designs/phong-ngu-mau/03-layout.svg" alt="Floor plan mẫu — phòng ngủ 3.5×4m" width="520">
</p>
...
Xem [ROADMAP.md](ROADMAP.md) — schema hoá artifacts, script kiểm hình học, hooks, skill review, lan truyền thay đổi; nguyên tắc xuyên suốt: human-in-the-loop.
